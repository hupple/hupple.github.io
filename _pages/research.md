...
Working paper coming soon 
<dl><dd>This paper investigates the impact of educational quality on future criminal behavior. We linked the universe of public school records to administrative criminal justice records for the state of North Carolina. We observe strong associations between future  criminal activity and early life education outcomes, namely test scores, attendance, and disciplinary records. We then evaluate the causal  effect of teacher quality on crime by estimating teachers’ value-added (VA) along cognitive and non-cognitive dimensions. We find that teachers with high VA in both dimensions reduce their students’ criminal involvement. The non-cognitive channel is the dominant channel,  emphasizing the need to evaluate teachers along multiple dimensions. We then estimate a multivariate random effects model to  simultaneously determine teachers’ impacts along several outcomes. The results indicate that teacher evaluations using test score quality measures alone may limit our  ability to reduce crime through the education system.</dd></dl>
